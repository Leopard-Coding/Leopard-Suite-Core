...
namespace LSC\lib\extension\SCSSPHP;

use LSC\lib\extension\SCSSPHP\Base\Range;
use LSC\lib\extension\SCSSPHP\Block;
use LSC\lib\extension\SCSSPHP\Colors;
use LSC\lib\extension\SCSSPHP\Compiler\Environment;
use LSC\lib\extension\SCSSPHP\Exception\CompilerException;
use LSC\lib\extension\SCSSPHP\Formatter\OutputBlock;
use LSC\lib\extension\SCSSPHP\Node;
use LSC\lib\extension\SCSSPHP\Type;
use LSC\lib\extension\SCSSPHP\Parser;
use LSC\lib\extension\SCSSPHP\Util;
...
class Compiler
{
    ...
    protected $formatter = 'LSC\lib\extension\SCSSPHP\Formatter\Nested';
     ...
     * @param string $path
     *
     * @return \LSC\lib\extension\SCSSPHP\Parser
     */
     ...
     *
     * @return \LSC\lib\extension\SCSSPHP\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \LSC\lib\extension\SCSSPHP\Block $rootBlock
     */
     ...
     * Flatten selectors
     *
     * @param \LSC\lib\extension\SCSSPHP\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \LSC\lib\extension\SCSSPHP\Block $media
     */
     ...
     * Media parent
     *
     * @param \LSC\lib\extension\SCSSPHP\Formatter\OutputBlock $scope
     *
     * @return \LSC\lib\extension\SCSSPHP\Formatter\OutputBlock
     */
     ...
     * Compile directive
     *
     * @param \LSC\lib\extension\SCSSPHP\Block $block
     */
     ...
     * @param integer $without
     *
     * @return \LSC\lib\extension\SCSSPHP\Compiler\Environment
     */
     ...
     *
     * @param array                                $stms
     * @param \LSC\lib\extension\SCSSPHP\Formatter\OutputBlock $out
     *
     * @return array
     */
     ...
     *
     * @param \LSC\lib\extension\SCSSPHP\Compiler\Environment $env
     *
     * @return array
     */
     ...
     *
     * @return \LSC\lib\extension\SCSSPHP\Compiler
     */
     ...
     *
     * @throws \LSC\lib\extension\SCSSPHP\Exception\CompilerException
     */
